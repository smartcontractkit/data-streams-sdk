...
func TestData(t *testing.T) {
	...
	feedID := [32]uint8{00, 07, 107, 74, 167, 229, 124, 167, 182, 138, 225, 191, 69, 101, 63, 86, 182, 86, 253, 58, 163, 53, 239, 127, 174, 105, 107, 102, 63, 27, 132, 114}
	...
	if d.ExchangeRate.Cmp(exchangeRate) != 0 {
		t.Errorf("ExchangeRate mismatch: expected %v, got %v", exchangeRate, d.ExchangeRate)
	}
}
